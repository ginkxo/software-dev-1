...
public class Graph {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("$" + x.getShortestRouteCost(A));
    	ArrayList<City> y = x.getShortestRoute(A);
    	if (y != null) {
    	for (City z : y) {System.out.println(z.getName());}
    	System.out.println("The distribution centre is named: " + (y).get(0).getName()); // this is the Distribution centre city name!
