...
public class Grid {
    ...
    private void buildMap() throws HeapEmptyException, HeapFullException {
        ...
        map[treasureSetY][treasureSetX] = treasure;
    ...
    public void findPath(Node startNode, Node targetNode)
        ...
        while (!openSet.isEmpty()) {
            ...
            System.out.println("Starting a new current ...");
            ...
            for (Node node : neighbours) {
                ...
                System.out.println("----- Is this the target node??");
                System.out.println(node.equals(targetNode));

                if (node.equals(targetNode)) {
                    node.parent = current;
                    System.out.println("This parent is ...");
        ...
        System.out.println("--- STATE OF OPEN SET:");
        System.out.println(openSet.isEmpty());
    }
    ...
    public ArrayList<Node> retracePath(Node startNode, Node endNode) {
        ...
        System.out.println("Path retraced");
        return path;
    }
